...
type Msg[T CompactNodeInfo] struct {
	...
	R        *Return[T]  `bencode:"r,omitempty"` // RESPONSE type only
...
type CompactNodeInfo interface {
	~[]NodeInfo
}
...
type Return[T CompactNodeInfo] struct {
	...
	Nodes  T `bencode:"nodes,omitempty"`
...
func (r Return[T]) ForAllNodes(f func(NodeInfo)) {
